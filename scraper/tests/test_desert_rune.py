...
def test_desert_rune_has_six_non_empty_effects(desert_rune_html: str, urls: dict[str, str]) -> None:
...
def test_desert_rune_description_is_not_empty(desert_rune_html: str, urls: dict[str, str]) -> None:
    augment = parse_augment_page(urls["rune"], desert_rune_html)
